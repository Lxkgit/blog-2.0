      ...
      <div style="height: 30px;">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item style="cursor: pointer;" v-if="showType == 4"
            @click="showType = 4">传感器数据</el-breadcrumb-item>
            <el-breadcrumb-item style="cursor: pointer;" v-if="showType == 5"
            @click="showType = 5">传感器控制</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div style="display: flex; flex-flow: wrap; overflow-y: auto; align-items:flex-start; max-height: 680px;">
