  ...
  <div class="drag-verify-container">
    <div :style="dragVerifyImgStyle">
      ...
      <div class="refresh" v-if="showRefresh && !isPassing">
        ...
        <i class="closeIcon" @click="closeimg">
          <MyIcon type="icon-fail" />
        </i>
      </div>
      <div class="tips success" v-if="showTips && isPassing">{{ successTip }}
      </div>
      <div class="tips danger" v-if="showTips && !isPassing && showErrorTip">{{ failTip }}
      </div>
    </div>
