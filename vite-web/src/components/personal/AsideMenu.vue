...
let adminMenus: any = reactive({ data: [
  { 
    ...
    "list": [
      ...
      "children": [{ "id": 50, "parentId": 1, "menuName": "角色管理", "menuIcon": "", "menuPath": "/admin/role", "permission": "sys:role", "component": "", "menuType": "1", "list": null, "children": null, "label": "角色管理" }, { "id": 51, "parentId": 1, "menuName": "用户管理", "menuIcon": "", "menuPath": "/admin/user", "permission": "sys:user", "component": "", "menuType": "1", "list": null, "children": null, "label": "用户管理" }], 
      "label": "系统管理" 
    }, { 
      "id": 2, 
      "parentId": 0, 
