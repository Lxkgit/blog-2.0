...
-- ----------------------------
INSERT INTO `blog_data` VALUES (1, '2023-07-14 11:33:36', 6565, 3, 5, 2, 1, 5, 1, 2, 1, 96);
...
CREATE TABLE `content_count`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 575 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '博客用户内容数量统计' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of content_count
-- ----------------------------
INSERT INTO `content_count` VALUES (574, 1, 1, 2, 1);
